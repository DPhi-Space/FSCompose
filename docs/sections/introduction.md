...
The main components of the system are : 
 ...
 - **Browser GUI** The user interacts with the system through the Ground Data Segment Graphic User Interface (GDS GUI), which is launched on the web browser. Through it, commands can be sent and telemetry downlinked to and from the Core DPhi Software. For a more in-depth guide, check out the [Ground Data Segment guide](./sections/gds.md) section.
